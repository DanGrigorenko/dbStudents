...
## Описание
Это desktop приложения под ОС Linux Ubuntu 20.04 и выше. Целью было, используя реляционную базу данных, создать БД "Студенты" и таблицы:
+ "Специальности" 
+ "Предметы"
+ "Студенты"
+ "Оценки"

и реализовать пользовательский интерфейс для работы с БД.
___
